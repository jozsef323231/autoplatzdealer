...
namespace DealershipSystem.Migrations
{
    ...
    [Migration("20260223084832_UpdateGermanSeeds")]
    partial class UpdateGermanSeeds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DealershipSystem.Models.BodyType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            NameDeutsch = "Kei-Auto",
                            NameEnglish = "Kei Car"
                        },
                        new
                        {
                            ID = 2,
                            NameDeutsch = "Kompaktwagen",
                            NameEnglish = "Compact Car"
                        },
                        new
                        {
                            ID = 3,
                            NameDeutsch = "Minivan / Van",
                            NameEnglish = "Minivan/One-Box"
                        },
                        new
                        {
                            ID = 4,
                            NameDeutsch = "Limousine",
                            NameEnglish = "Sedan"
                        },
                        new
                        {
                        ...
                        {
                            ID = 8,
                            NameDeutsch = "Lkw / Transporter",
                            NameEnglish = "Truck/Van"
                        },
                        new
                        {
                            ID = 9,
                            NameDeutsch = "Schrägheck",
            ...
            modelBuilder.Entity("DealershipSystem.Models.Color", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            ColorNameDeutsch = "Weiß",
                            ColorNameEnglish = "White"
                        },
                        new
                        {
                            ID = 2,
                            ColorNameDeutsch = "Schwarz",
                            ColorNameEnglish = "Black"
                        },
                        new
                        {
                            ID = 3,
                            ColorNameDeutsch = "Rot",
                            ColorNameEnglish = "Red"
                        },
                        new
                        {
                            ID = 4,
                            ColorNameDeutsch = "Blau",
                            ColorNameEnglish = "Blue"
                        },
                        new
                        {
                            ID = 5,
                            ColorNameDeutsch = "Silber",
                            ColorNameEnglish = "Silver"
                        },
                        new
                        {
                            ID = 6,
                            ColorNameDeutsch = "Grau",
                        ...
                        {
                            ID = 11,
                            ColorNameDeutsch = "Rosa",
                            ColorNameEnglish = "Pink"
                        },
                        new
                        {
                            ID = 12,
                            ColorNameDeutsch = "Lila",
                            ColorNameEnglish = "Purple"
                        },
                        new
                        {
                            ID = 13,
                            ColorNameDeutsch = "Gelb",
                            ColorNameEnglish = "Yellow"
                        },
                        new
                        {
                            ID = 14,
                            ColorNameDeutsch = "Grün",
                            ColorNameEnglish = "Green"
                        },
                        new
                        {
                            ID = 15,
                            ColorNameDeutsch = "Andere",
