...
namespace DealershipSystem.Services
{
    ...
    public class CarService
    {
        ...
        public async Task<List<CarDTO>> GetAllCarsAsync()
        {
            ...
            // Always use English fields for car-related values (BodyType, Color, FuelType, etc.)
            // The DTOs now only have English fields, so nothing else is needed.
        ...
        public async Task<CarDTO?> GetCarByIdAsync(int id)
        {
            ...
            // Always use English fields for car-related values
