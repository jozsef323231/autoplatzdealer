...
## Projekt leírása
Az **Auto Platz** egy autókereskedés részére készült komplex megoldás, amely két fő részből áll:
...
A projekt célja egy modern és hatékony platform létrehozása, amely támogatja az autókereskedés mindennapi működését. A rendszer egyszerűsíti a járművek kezelését, nyilvántartását és online megjelenítését, miközben a magyar piac igényeihez igazodik. Rugalmas felépítésének és többnyelvű támogatásának köszönhetően hosszú távon is bővíthető és versenyképes megoldást kínál.
...
- **Munkatársak (WPF-alkalmazás)**:  
  ...
  Felhasználónév: admin@autoplatz.hu
  Jelszó: adminPassword1!
