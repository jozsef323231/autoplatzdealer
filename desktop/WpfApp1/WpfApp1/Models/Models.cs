...
namespace WpfApp1.Models
{
    public class CarMakerDTO
    {
        ...
        public string BrandDeutsch { get; set; } = string.Empty;
    }
    ...
    public class CarModelDTO
    {
        ...
        public string ModelNameDeutsch { get; set; }
    ...
    public class ColorDTO
    {
        ...
        public string ColorNameDeutsch { get; set; } = string.Empty;
    }

    public class FuelTypeDTO
    {
        public int ID { get; set; }
        public string NameDeutsch { get; set; } = string.Empty;
    ...
    public class CreateCarMakerDTO
    {
        ...
        public string BrandDeutsch { get; set; }
    }
